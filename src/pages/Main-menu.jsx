...
function MainMenu() {
  ...
  const StageLink = ({ stageNumber, to, className }) => {
    ...
    const baseClassName = className.replace("bg-purple-100", "");
    const bgColor = isAccessible ? "bg-purple-100" : "bg-red-100";
    ...
    // Accessible stage
    return (
      <Link to={to} className={`${className} hover:bg-purple-200`}>
        {/* Corner decorations */}
        <div className="absolute -top-1 -left-1 w-3 h-3 border-t-2 border-l-2 border-purple-600"></div>
        <div className="absolute -top-1 -right-1 w-3 h-3 border-t-2 border-r-2 border-purple-600"></div>
        <div className="absolute -bottom-1 -left-1 w-3 h-3 border-b-2 border-l-2 border-purple-600"></div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-zinc-900 to-purple-950 ">
      ...
      <div
        className="w-[8vw] h-[8vw] bg-gradient-to-b from-purple-300 via-white to-zinc-500 border-4 border-purple-400 absolute left-7 top-1/2 transform -translate-y-1/2 z-30 text-center flex items-center justify-center cursor-pointer hover:bg-purple-50 transition-colors duration-200"
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            <div className="bg-gradient-to-br from-purple-800 via-zinc-900 to-purple-950 backdrop-blur-sm p-8 border-4 border-purple-400 shadow-2xl z-10 h-[90vh] relative">
              ...
              <div className="text-center mb-8">
                <div className="bg-purple-100 border-2 border-purple-400 inline-block px-6 py-3 relative">
                  <div className="absolute top-1 left-1 w-2 h-2 bg-purple-400 rotate-45"></div>
                  <div className="absolute top-1 right-1 w-2 h-2 bg-purple-400 rotate-45"></div>
              ...
              <StageLink
                stageNumber={1}
                to="/stage1"
                className="w-[10vw] h-[10vw] bg-purple-100 border-4 border-purple-400 absolute left-1/2 top-1/4 transform -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center justify-center cursor-pointer transition-colors duration-200 group"
              />
              <StageLink
                stageNumber={2}
                to="/stage2"
                className="w-[10vw] h-[10vw] bg-purple-100 border-4 border-purple-400 absolute right-1/4 top-1/3 transform translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center justify-center cursor-pointer transition-colors duration-200 group"
              />
              <StageLink
                stageNumber={3}
                to="/stage3"
                className="w-[10vw] h-[10vw] bg-purple-100 border-4 border-purple-400 absolute right-1/4 bottom-1/3 transform translate-x-1/2 translate-y-1/2 z-20 flex flex-col items-center justify-center cursor-pointer transition-colors duration-200 group"
              />
              <StageLink
                stageNumber={4}
                to="/stage4"
                className="w-[10vw] h-[10vw] bg-purple-100 border-4 border-purple-400 absolute left-1/2 bottom-1/4 transform -translate-x-1/2 translate-y-1/2 z-20 flex flex-col items-center justify-center cursor-pointer transition-colors duration-200 group"
              />
              <StageLink
                stageNumber={5}
                to="/stage5"
                className="w-[10vw] h-[10vw] bg-purple-100 border-4 border-purple-400 absolute left-1/4 bottom-1/3 transform -translate-x-1/2 translate-y-1/2 z-20 flex flex-col items-center justify-center cursor-pointer transition-colors duration-200 group"
              />
              <StageLink
                stageNumber={6}
                to="/stage6"
                className="w-[10vw] h-[10vw] bg-purple-100 border-4 border-purple-400 absolute left-1/4 top-1/3 transform -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center justify-center cursor-pointer transition-colors duration-200 group"
              />
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-10 left-10 text-4xl text-purple-400 opacity-20 animate-pulse font-mono">
                  ◆
              ...
              <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                <div className="w-32 h-32 border-4 border-purple-300 bg-purple-50 rotate-45 opacity-50"></div>
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -rotate-45">
                  <div className="bg-purple-100 border-2 border-purple-400 px-3 py-1">
