    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-zinc-900 to-purple-950 relative overflow-hidden ">
      {showDialogue && (
        <>
          ...
          <div className="fixed inset-0 bg-gradient-to-br from-black via-zinc-900 to-purple-950 bg-opacity-80 z-20 pointer-events-none transition-all duration-500 flex items-center justify-center w-full">
