  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-100 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative w-full h-full z-10">
        <div className=" backdrop-blur-sm p-8 border-4 border-purple-400 shadow-2xl relative overflow-hidden flex h-[90vh] flex-col items-center justify-center">
          {/* Retro border decorations */}

          <div className="max-w-2xl w-full text-center z-10">
            <h1 className="text-4xl font-mono font-bold text-purple-700 mb-6">
              [Privacy Policy]
            </h1>
          </div>
