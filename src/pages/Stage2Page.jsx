...
function Stage2Page() {
  ...
  const fullText =
    "One stage down, lets do another. We need to fix the engine as soon as possible! But first, we need the right equipment. You will have to jump for reaching it. Good luck!";
