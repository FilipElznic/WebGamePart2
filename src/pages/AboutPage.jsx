    ...
    <>
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          {/* Main About Section */}
          <div className="bg-gradient-to-br from-black via-zinc-900 to-purple-950 p-8 border-4 border-purple-400 shadow-2xl mb-8">
              ...
              <div className="bg-purple-50 border-2 border-purple-400 p-6 relative">
                ...
                <div className="font-mono text-gray-800 space-y-3">
                  ...
                  <div className="bg-white border border-purple-300 p-3 mt-4">
                    ...
                    <p className="text-sm">
                      <span className="text-purple-600">⧗</span> Continuous
                      updates
                    </p>
                  </div>
                </div>
