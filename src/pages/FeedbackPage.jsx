  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-zinc-900 to-purple-950 relative overflow-hidden">
          ...
          <div className="absolute bottom-3/5 left-1/4 z-40 max-w-md">
            <div className="bg-white border-4 border-purple-400 rounded-lg p-4 relative shadow-xl">
              ...
              <div className="text-black font-mono">
                <p className="text-lg font-bold text-purple-700 mb-2">Peter:</p>
      ...
      <div className="container mx-auto px-4 py-8 relative w-full h-full z-10 bg-gradient-to-br from-black via-zinc-900 to-purple-950">
        <div className="backdrop-blur-sm p-8 border-4 border-purple-400 shadow-2xl relative overflow-hidden min-h-[90vh]">
          ...
          <div className="text-center mb-8 relative">
            <div className="inline-block bg-black text-purple-400 px-8 py-4 border-4 border-purple-500 font-mono text-4xl font-bold relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-purple-400 to-transparent opacity-20"></div>
              <div className="relative z-10">
                &gt;&gt; FEEDBACK_TERMINAL &lt;&lt;
              </div>
              <div className="absolute -top-2 -left-2 w-4 h-4 border-t-4 border-l-4 border-purple-300"></div>
              <div className="absolute -top-2 -right-2 w-4 h-4 border-t-4 border-r-4 border-purple-300"></div>
              <div className="absolute -bottom-2 -left-2 w-4 h-4 border-b-4 border-l-4 border-purple-300"></div>
              <div className="absolute -bottom-2 -right-2 w-4 h-4 border-b-4 border-r-4 border-purple-300"></div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="bg-black border-4 border-purple-400 p-6 relative">
                <div className="absolute -top-1 -left-1 w-3 h-3 bg-purple-400"></div>
                ...
                <form onSubmit={handleSubmitFeedback} className="space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-purple-900 text-purple-100 border-2 border-purple-400 p-2 font-mono focus:border-purple-300 focus:outline-none"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-purple-900 text-purple-100 border-2 border-purple-400 p-2 font-mono focus:border-purple-300 focus:outline-none placeholder-purple-600"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows="6"
                      className="w-full bg-purple-900 text-purple-100 border-2 border-purple-400 p-3 font-mono focus:border-purple-300 focus:outline-none placeholder-purple-600 resize-none"
                      required
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-purple-400 hover:bg-purple-300 disabled:bg-purple-600 disabled:cursor-not-allowed text-black font-mono font-bold py-3 px-6 border-2 border-purple-600 transition-all duration-200 transform hover:scale-105 relative group"
                  >
                    <div className="absolute -top-1 -left-1 w-2 h-2 border-t-2 border-l-2 border-purple-800"></div>
                    <div className="absolute -top-1 -right-1 w-2 h-2 border-t-2 border-r-2 border-purple-800"></div>
                    <div className="absolute -bottom-1 -left-1 w-2 h-2 border-b-2 border-l-2 border-purple-800"></div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-black border-4 border-purple-400 p-6 relative">
                ...
                <div className="font-mono text-gray-200  space-y-3">
                  ...
                  <div className="bg-purple-400 border border-purple-300 p-3 mt-4">
                    ...
                    <p className="text-sm mb-1">
                      <span className="text-purple-600">&gt;</span> COOKIES:
                      DISABLED
                    </p>
                    <p className="text-sm">
                      <span className="text-purple-600">&gt;</span> TRACKING:
                      NULL
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-black  border-4 border-purple-400 p-6 relative">
                ...
                <div className="font-mono text-gray-200 space-y-3">
                  ...
                  <p className="text-sm leading-relaxed">
                    <span className="text-purple-600 font-bold">&gt;</span> Tell
              ...
              <div className="bg-black border-4 border-purple-400 p-6 relative">
                ...
                <div className="font-mono text-gray-200 space-y-3">
                  ...
                  <div className="bg-black text-purple-400 border border-purple-300 p-3 mt-4 font-mono text-sm">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-10 left-10 text-4xl text-purple-400 opacity-20 font-mono">
          ◆
        </div>
        <div className="absolute top-20 right-20 text-3xl text-purple-500 opacity-30 font-mono">
          ★
        </div>
        <div className="absolute bottom-32 left-20 text-4xl text-purple-400 opacity-25 font-mono">
          ◇
        </div>
        <div className="absolute bottom-20 right-32 text-3xl text-purple-500 opacity-20 font-mono">
          ♦
        </div>
        <div className="absolute top-1/3 left-1/4 text-2xl text-purple-400 opacity-20 font-mono">
          ▲
        </div>
        <div className="absolute top-2/3 right-1/4 text-3xl text-purple-500 opacity-30 font-mono">
          ●
        </div>
        <div className="absolute top-1/2 left-10 text-2xl text-purple-400 opacity-25 font-mono">
          ▼
        </div>
        <div className="absolute top-3/4 right-10 text-3xl text-purple-500 opacity-20 font-mono">
          ◆
        </div>
        <div className="absolute top-1/4 right-1/3 text-2xl text-purple-400 opacity-30 font-mono">
          ◄
        </div>
        <div className="absolute bottom-1/4 left-1/3 text-3xl text-purple-500 opacity-25 font-mono">
          ►
        </div>
